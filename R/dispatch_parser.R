...
#' @keywords internal
#'
dispatch_parser <- function(filename, decimal = ".", sep = NULL, specnum = 1L) {
  switch(
    ...
    rfl8 = lr_parse_avantes_rfl8(filename, specnum),
    raw8 = lr_parse_avantes_raw8(filename, specnum),
    irr8 = lr_parse_avantes_irr8(filename, specnum),
